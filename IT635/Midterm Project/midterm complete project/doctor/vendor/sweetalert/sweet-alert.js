...
;(function(window, document, undefined) {
    ...
    var onButtonEvent = function(event) {
      ...
      switch (e.type) {
        ...
        case ("mouseup"):
          ...
          break;
        case ("focus"):
          var $pgsql_connfirmButton = modal.querySelector('button.confirm'),
              $cancelButton  = modal.querySelector('button.cancel');

          if (targetedConfirm) {
            $cancelButton.style.boxShadow = 'none';
          } else {
            $pgsql_connfirmButton.style.boxShadow = 'none';
          }
          break;
        case ("click"):
  ...
  function setParameters(params) {
    ...
    var $title = modal.querySelector('h2'),
        ...
        $pgsql_connfirmBtn = modal.querySelector('button.confirm');
    ...
    if (params.showConfirmButton) {
      $pgsql_connfirmBtn.style.display = 'inline-block';
    } else {
      hide($pgsql_connfirmBtn);
    }
    ...
    if (params.confirmButtonText) {
      $pgsql_connfirmBtn.innerHTML = escapeHtml(params.confirmButtonText);
    }

    // Set confirm button to selected background color
    $pgsql_connfirmBtn.style.backgroundColor = params.confirmButtonColor;

    // Set box-shadow to default focused button
    setFocusStyle($pgsql_connfirmBtn, params.confirmButtonColor);
