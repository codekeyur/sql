...
$query=pg_query($link,"update receptionist set password='$newpassword' where first_name='$name' and email='$email'");
if ($query) {
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> HMS | Receptionist Reset Password</h2></a>
				</div>
